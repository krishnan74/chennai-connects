    ...
    <div className='grid-gallery w-full max-w-[900px] mx-auto my-20 gap-1 grid overflow-hidden relative'>
      ...
      <div className='grid-item col-span-2 relative'>
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-white text-[100px] font-bold bg-black bg-opacity-30">CHENNAI CONNECT</div>
        </div>
      </div>
    ...
    <a href="/Gallery">
      <div className='grid-item relative'>
        <div className='relative'>
          ...
          <div className='absolute inset-0 flex items-center justify-center text-white font-serif font-bold bg-black bg-opacity-30'>view more ➤</div>
        </div>
      </div>
</a>
    </div>
